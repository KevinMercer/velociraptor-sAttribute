 ...
 * @describe
 */
public class DiamondNetheriteChest extends ArmorItem {

    public DiamondNetheriteChest(Settings settings) {
        super(NetheriteMaterials.DIAMOND_NETHERITE, EquipmentSlot.CHEST, settings);
    }
